...
import { PlusIcon, DownloadIcon, UploadIcon } from '@/components/ui/icons';
...
export default function Dashboard() {
  ...
  const handleImportPdf = (extractedTransactions) => {
    importTransactionsFromPdf(extractedTransactions);
    ...
    <AppLayout>
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handleOpenImportDialog} variant="outline" size="sm" className="gap-1">
